/*
 * @Author: 明华
 * @Date: 2021-01-08 11:04:43
 * @LastEditors: 明华
 * @LastEditTime: 2021-01-08 11:56:41
 * @Description: 
 * @FilePath: /shop_flutter/lib/config/server_url.dart
 */
...
class ServerUrl {
  ...
  static const String CATEGORY_FIRST =
      BASE_URL + '/catalog/getfirstcategory'; //商品分类第一级
  static const String CATEGORY_SECOND =
